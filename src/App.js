...
class App extends Component {
	...
	render() {
		return (
			<div id='app'>
				<h1 className="title">You Quotes</h1>
				<div className='content'>
					...
					<FacebookProvider appId="1545891592136985">
						<ShareButton className="btn btn-lg quote-button" href="http://www.facebook.com" />
					</FacebookProvider>
...
const Button = ({ getQuote }) => (
	<button className="btn quote-button pull-right" onClick={getQuote}>New Quote!</button>
);
